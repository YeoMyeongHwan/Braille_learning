...
public class Menu_info {
    ...
    public static int MENU_MASTER_LETTER= 1; // 글자연습
    public static int MENU_MASTER_WORD = 2; //단어 연습
    ...
    public static int MENU_MYNOTE_BASIC = 1; //기초단어장
    public static int MENU_MYNOTE_MASTER = 2; //숙련단어장

    public static int MENU_TUTORIAL = 1; //사용설명서
    public static int MENU_BASIC_PRACTICE = 2; //기초과정
    public static int MENU_MASTER_PRACTICE = 3; //숙련과정
