...
public class Quiz_Braille_short_practice extends FragmentActivity implements TextToSpeech.OnInitListener {
/*
3칸 이하의 점자 퀴즈를 진행하는 클래스
*/
    Quiz_Braille_short_display m;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = new Quiz_Braille_short_display(this);
